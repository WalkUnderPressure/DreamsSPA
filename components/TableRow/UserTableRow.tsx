  ...
  render() {
    ...
    return (
      <tr className='text-center'>
        ...
        <td className='py-3 pl-2 pr-0'>{element && element.get("lastName")}</td>
        
        <td className='py-3 pl-2 pr-0'>{element && element.get("role")}</td>
        <td className='py-3 pl-2 pr-0'>{element && element.get("email")}</td>
